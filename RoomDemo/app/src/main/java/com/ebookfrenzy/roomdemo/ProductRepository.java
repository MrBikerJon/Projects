...
public class ProductRepository {
    ...
    // Method that the ViewModel can call to obtain references to the allProducts live data object
    public LiveData<List<Product>> getAllProducts() {
        return allProducts;
    }

    // Method that the ViewModel can call to obtain references to the searchResults live data object
